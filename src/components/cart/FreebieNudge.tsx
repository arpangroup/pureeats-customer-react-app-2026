...
export function FreebieNudge({ coupons, subtotal }: { coupons: Coupon[]; subtotal: number }) {
  ...
  return (
    <div className="fixed inset-x-3 z-30 mx-auto flex max-w-md items-center gap-2 rounded-xl bg-slate-800 px-3.5 py-2.5 text-white shadow-lg animate-fade-in bottom-[calc(9.5rem+env(safe-area-inset-bottom))] md:bottom-24 md:right-6 md:left-auto md:mx-0 dark:bg-slate-700">
