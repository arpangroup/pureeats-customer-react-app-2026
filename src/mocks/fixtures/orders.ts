...
export const ordersByUser: Record<number, Order[]> = {
  12: [
    ...
    order({
      ...
      total: 655, payable: 685, paymentMode: 'ONLINE', deliveryPin: '7734', orderComment: 'Ring the bell twice', deliveryType: 'DELIVERY',
    ...
    order({
      ...
      total: 611, payable: 641, paymentMode: 'ONLINE', deliveryPin: '3390', orderComment: null, deliveryType: 'DELIVERY',
    ...
    order({
      ...
      total: 424, payable: 454, paymentMode: 'ONLINE', deliveryPin: '6673', orderComment: null, deliveryType: 'DELIVERY',
    ...
    order({
      ...
      total: 370, payable: 400, paymentMode: 'ONLINE', deliveryPin: '4456', orderComment: null, deliveryType: 'DELIVERY',
