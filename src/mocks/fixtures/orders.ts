...
export const ordersByUser: Record<number, Order[]> = {
  12: [
    order({
      ...
      coupon: null, tax: 22, restaurantCharge: 20, deliveryCharge: 25, platformFee: 0, driverTipAmount: 0, discountAmount: 0,
    ...
    order({
      ...
      coupon: null, tax: 30, restaurantCharge: 25, deliveryCharge: 30, platformFee: 0, driverTipAmount: 0, discountAmount: 0,
    ...
    order({
      ...
      coupon: null, tax: 28, restaurantCharge: 25, deliveryCharge: 30, platformFee: 0, driverTipAmount: 0, discountAmount: 0,
    ...
    order({
      ...
      coupon: null, tax: 29, restaurantCharge: 20, deliveryCharge: 20, platformFee: 0, driverTipAmount: 20, discountAmount: 0,
    ...
    order({
      ...
      coupon: null, tax: 15, restaurantCharge: 10, deliveryCharge: 20, platformFee: 0, driverTipAmount: 0, discountAmount: 0,
    ...
    order({
      ...
      tax: 26, restaurantCharge: 20, deliveryCharge: 0, platformFee: 0, driverTipAmount: 0, discountAmount: 25,
    ...
    order({
      ...
      coupon: null, tax: 19, restaurantCharge: 25, deliveryCharge: 30, platformFee: 0, driverTipAmount: 30, discountAmount: 0,
    ...
    order({
      ...
      coupon: null, tax: 13, restaurantCharge: 10, deliveryCharge: 0, platformFee: 0, driverTipAmount: 0, discountAmount: 0,
    ...
    order({
      ...
      coupon: null, tax: 16, restaurantCharge: 25, deliveryCharge: 30, platformFee: 0, driverTipAmount: 0, discountAmount: 0,
  ...
  13: [
    order({
      ...
      coupon: null, tax: 14, restaurantCharge: 15, deliveryCharge: 22, platformFee: 0, driverTipAmount: 0, discountAmount: 0,
