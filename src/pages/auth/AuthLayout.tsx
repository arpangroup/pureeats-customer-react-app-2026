      ...
      <div className="flex flex-1 flex-col items-center justify-center px-5 py-10 sm:py-16">
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-50">PureEats</h1>
            <p className="text-sm text-slate-500 dark:text-slate-400">Food, delivered fast.</p>
          </div>
        </div>
