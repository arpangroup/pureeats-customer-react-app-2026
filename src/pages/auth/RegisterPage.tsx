...
export default function RegisterPage() {
  ...
  return (
    <div className="card p-6">
      <h2 className="mb-1 text-lg font-semibold text-slate-800 dark:text-slate-100">Create account</h2>
      <p className="mb-5 text-sm text-slate-500 dark:text-slate-400">Takes less than a minute.</p>
