...
// This is the ONLY place that knows how to talk to the real backend — the
// same Spring Boot app the admin panel (pureeats-react-ui) talks to. Every
// service in src/services/* calls through here when DATA_SOURCE === 'live'.
