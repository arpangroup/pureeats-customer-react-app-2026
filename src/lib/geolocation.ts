...
/** Calls `onChange` whenever the permission state flips (e.g. the user updates it in browser settings and comes back). Returns a no-op unsubscribe when the Permissions API isn't available. */
